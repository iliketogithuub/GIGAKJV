...
The text of the Simple King James Version (SKJV) Bible may be quoted in any form (written, visual, electronic, or audio) up to and inclusive of one thousand (1,000) verses without express written permission of the publisher, providing that the verses quoted do not amount to a complete book of the Bible, nor do the verses quoted account for more than 50% of the total work in which they are quoted.
...
When quotations from the SKJV text are used in non-salable media, such as church bulletins, orders of service, posters, transparencies, or similar media, a complete copyright notice is not required, but the initials (SKJV) must appear at the end of each quotation.

Any commentary or other work that duplicates more than one thousand (1,000) verses or is intended for commercial resale must secure express written permission from the SKJV Publishing Team.
